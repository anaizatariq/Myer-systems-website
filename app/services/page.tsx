    ...
    <div className="bg-background min-h-screen">
      ...
      <section className="relative w-full pt-32 pb-24 lg:pt-40 lg:pb-36 overflow-hidden bg-[#060D14]">
        ...
        <div 
          ...
          aria-hidden="true" 
        />
        <div className="absolute inset-0 z-0 bg-gradient-to-r from-[#060D14]/95 via-[#060D14]/50 to-transparent" aria-hidden="true" />
        <div className="absolute inset-0 z-0 bg-gradient-to-t from-[#060D14] via-transparent to-[#060D14]/30" aria-hidden="true" />
        {/* No extra dark layer needed */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            ...
            <div className="reveal lg:col-span-8 xl:col-span-8 space-y-6 lg:space-y-8">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-[3.5rem] xl:text-[4rem] leading-[1.1] font-bold tracking-tight text-white font-heading pt-2 drop-shadow-[0_4px_24px_rgba(0,0,0,0.6)]">
                Systems built to make complex operations predictable.
              </h1>

              {/* 1. HERO SUBTEXT */}
              <p className="text-lg sm:text-xl lg:text-[22px] leading-relaxed text-[#F0FAFF] font-sans max-w-2xl drop-shadow-[0_2px_10px_rgba(0,0,0,0.8)]">
      ...
      <section className="pb-14 sm:pb-20 lg:pb-32 pt-2 bg-[#FAFAFA]">
        <div className="mx-auto max-w-[85rem] px-6 lg:px-8 space-y-5 sm:space-y-8 lg:space-y-10">
          ...
          <div className="reveal-up w-full flex flex-col md:flex-row border border-[#1A6FA8]/15 rounded-[2rem] bg-white group hover:bg-[#E0F4FC] transition-all duration-700 hover:shadow-[0_20px_40px_rgba(26,111,168,0.12)] border-l-[6px] border-l-[#29A8E0] overflow-hidden">
            ...
            <div className="w-full md:w-1/2 p-5 sm:p-6 lg:p-8 bg-[#8FD6F5] rounded-b-[2rem] md:rounded-b-none md:rounded-l-[2.5rem] relative z-10 transition-transform duration-700 group-hover:-translate-x-2 flex flex-col justify-center shadow-[-10px_0_30px_rgba(41,168,224,0.15)] overflow-hidden">
              ...
              <div className="relative z-10">
                <div>
                  <h4 className="text-xl sm:text-[22px] font-bold text-ink font-heading mb-3 tracking-tight">Built for Accountability</h4>
          ...
          <div className="reveal-up w-full flex flex-col md:flex-row border border-[#1A6FA8]/15 rounded-[2rem] bg-white group hover:bg-[#E0F4FC] transition-all duration-700 hover:shadow-[0_20px_40px_rgba(26,111,168,0.12)] border-l-[6px] border-l-[#29A8E0] overflow-hidden">
            ...
            <div className="w-full md:w-1/2 p-5 sm:p-6 lg:p-8 bg-[#8FD6F5] rounded-b-[2rem] md:rounded-b-none md:rounded-l-[2.5rem] relative z-10 transition-transform duration-700 group-hover:-translate-x-2 flex flex-col justify-center shadow-[-10px_0_30px_rgba(41,168,224,0.15)] overflow-hidden">
              ...
              <div className="relative z-10">
                <div>
                  <h4 className="text-xl sm:text-[22px] font-bold text-ink font-heading mb-3 tracking-tight">Flagship Product: MedSynthea</h4>
          ...
          <div className="reveal-up w-full flex flex-col md:flex-row border border-[#1A6FA8]/15 rounded-[2rem] bg-white group hover:bg-[#E0F4FC] transition-all duration-700 hover:shadow-[0_20px_40px_rgba(26,111,168,0.12)] border-l-[6px] border-l-[#29A8E0] overflow-hidden">
            ...
            <div className="w-full md:w-1/2 p-5 sm:p-6 lg:p-8 bg-[#8FD6F5] rounded-b-[2rem] md:rounded-b-none md:rounded-l-[2.5rem] relative z-10 transition-transform duration-700 group-hover:-translate-x-2 flex flex-col justify-center shadow-[-10px_0_30px_rgba(41,168,224,0.15)] overflow-hidden">
              ...
              <div className="relative z-10">
                <div>
                  <h4 className="text-xl sm:text-[22px] font-bold text-ink font-heading mb-3 tracking-tight">The Best of Both Worlds</h4>
          ...
          <div className="reveal-up w-full flex flex-col md:flex-row border border-[#1A6FA8]/15 rounded-[2rem] bg-white group hover:bg-[#E0F4FC] transition-all duration-700 hover:shadow-[0_20px_40px_rgba(26,111,168,0.12)] border-l-[6px] border-l-[#29A8E0] overflow-hidden">
            ...
            <div className="w-full md:w-1/2 p-5 sm:p-6 lg:p-8 bg-[#8FD6F5] rounded-b-[2rem] md:rounded-b-none md:rounded-l-[2.5rem] relative z-10 transition-transform duration-700 group-hover:-translate-x-2 flex flex-col justify-center shadow-[-10px_0_30px_rgba(41,168,224,0.15)] overflow-hidden">
              <div className="absolute inset-0 z-0 opacity-[0.05]" style={{ backgroundImage: 'radial-gradient(#29A8E0 2px, transparent 2px)', backgroundSize: '24px 24px' }} />
              <div className="relative z-10">
                <ul className="grid xl:grid-cols-2 gap-4 text-slate-700 text-[16px] text-[15px] font-medium">
                  <li className="flex items-center gap-2.5 bg-white p-3.5 rounded-xl border border-[#1A6FA8]/10 shadow-sm"><Check className="w-4 h-4 text-[#29A8E0] shrink-0" /> Patient access & eligibility</li>
                  <li className="flex items-center gap-2.5 bg-white p-3.5 rounded-xl border border-[#1A6FA8]/10 shadow-sm"><Check className="w-4 h-4 text-[#29A8E0] shrink-0" /> AI-assisted coding & billing</li>
                  <li className="flex items-center gap-2.5 bg-white p-3.5 rounded-xl border border-[#1A6FA8]/10 shadow-sm"><Check className="w-4 h-4 text-[#29A8E0] shrink-0" /> Claims submission & denials</li>
                  <li className="flex items-center gap-2.5 bg-white p-3.5 rounded-xl border border-[#1A6FA8]/10 shadow-sm"><Check className="w-4 h-4 text-[#29A8E0] shrink-0" /> Collections & payment</li>
                  <li className="flex items-center gap-2.5 bg-white p-3.5 rounded-xl border border-[#1A6FA8]/10 shadow-sm"><Check className="w-4 h-4 text-[#29A8E0] shrink-0" /> Reporting & compliance</li>
                  <li className="flex items-center gap-2.5 bg-white p-3.5 rounded-xl border border-[#1A6FA8]/10 shadow-sm"><Check className="w-4 h-4 text-[#29A8E0] shrink-0" /> Offshore medical coding</li>
                </ul>
              </div>
            </div>
