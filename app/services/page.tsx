        ...
        <div className="mx-auto w-full max-w-7xl px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 xl:gap-12 items-center">
            ...
            <div className="reveal lg:col-span-7 xl:col-span-7 space-y-6">
              ...
              {/* 1. HERO H1 */}
              <h1 className="text-3xl sm:text-4xl lg:text-[2.75rem] xl:text-[3.15rem] leading-[1.28] sm:leading-[1.26] lg:leading-[1.24] font-bold tracking-tight text-ink font-heading max-w-2xl pt-1">
              ...
              <div className="pt-2 flex flex-wrap items-center gap-4">
                <Link
                  href="/contact"
                  className="group inline-flex items-center gap-2.5 rounded-full bg-[#29A8E0] px-7 py-3.5 text-sm font-bold text-ink shadow-md shadow-[#29A8E0]/20 hover:bg-[#209FD6] hover:shadow-[0_6px_20px_rgba(41,168,224,0.38)] hover:-translate-y-0.5 active:translate-y-0 active:scale-[0.99] transition-all duration-200 font-ui cursor-pointer"
                >
            ...
            <div className="reveal-scale lg:col-span-5 xl:col-span-5 flex justify-center lg:justify-end">
              <div className="relative w-full max-w-[450px] sm:max-w-[480px] lg:max-w-[490px] xl:max-w-[510px] mx-auto lg:mr-0 pt-3 pb-3">
                ...
                <div className="absolute -top-2 left-2 z-30 inline-flex items-center gap-2 rounded-full bg-white/95 backdrop-blur-md border border-[#1A6FA8]/20 px-3.5 py-1 shadow-md shadow-slate-900/6">
                  <span className="h-1.5 w-1.5 rounded-full bg-[#29A8E0] animate-pulse" />
                  <span className="text-[11px] font-medium text-ink font-sans">Enterprise AI</span>
                </div>
                ...
                <div className="absolute top-1/2 -right-2 z-30 inline-flex items-center gap-2 rounded-full bg-white/95 backdrop-blur-md border border-[#1A6FA8]/20 px-3.5 py-1 shadow-md shadow-slate-900/6 -translate-y-1/2">
                  ...
                  <span className="text-[11px] font-medium text-ink font-sans">Healthcare Technology</span>
                </div>
                ...
                <div className="absolute -bottom-1 left-4 z-30 inline-flex items-center gap-2 rounded-full bg-white/95 backdrop-blur-md border border-[#1A6FA8]/20 px-3.5 py-1 shadow-md shadow-slate-900/6">
                  ...
                  <span className="text-[11px] font-medium text-ink font-sans">Operational Transformation</span>
                </div>
          ...
          <div className="space-y-20 lg:space-y-28">
            ...
            <div id="ai-solutions" className="scroll-mt-28 grid lg:grid-cols-12 gap-10 lg:gap-14 items-center">
              <div className="reveal lg:col-span-7 space-y-4">
                ...
                <h3 className="text-2xl sm:text-3xl font-bold text-ink font-heading leading-tight">
      ...
      <section className="py-20 lg:py-24 relative bg-gradient-to-b from-[#F8FAFD] via-[#F0FAFF] to-[#F8FAFD] overflow-hidden border-y border-[#1A6FA8]/15">
        <div className="mx-auto max-w-7xl px-6 lg:px-8 relative z-10">
          ...
          <div className="reveal text-center mb-12 lg:mb-16 max-w-3xl mx-auto">
            ...
            {/* 4. VALUE HEADING */}
            <h2 className="text-3xl font-bold tracking-tight text-ink sm:text-4xl lg:text-[2.6rem] font-heading">
            ...
            {[
              ...
              >
                <div>
                  ...
                  <h3 className="text-lg font-bold text-ink mb-2 font-heading leading-snug">{item.title}</h3>
      ...
      <section className="py-20 lg:py-24 bg-[#F8FAFD] border-b border-[#1A6FA8]/15">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="reveal text-center max-w-2xl mx-auto mb-16">
            ...
            <h2 className="text-3xl font-bold tracking-tight text-ink sm:text-4xl font-heading">
          ...
          <div className="rounded-3xl border border-[#1A6FA8]/25 bg-gradient-to-br from-[#F8FAFD] via-white to-[#F0FAFF] p-8 sm:p-10 lg:p-14 shadow-lg shadow-[#1A6FA8]/5 relative overflow-hidden">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center relative z-10">
              ...
              <div className="reveal lg:col-span-6 space-y-5">
                ...
                {/* 7. HEADING */}
                <h2 className="text-3xl sm:text-4xl font-bold tracking-tight text-ink font-heading leading-tight">
                ...
                <div className="pt-3 flex flex-wrap items-center gap-4">
                  <Link
                    href="/contact"
                    className="inline-flex items-center gap-2 rounded-full bg-[#29A8E0] px-6 py-3 text-xs sm:text-sm font-bold text-ink shadow-md shadow-[#29A8E0]/20 hover:bg-[#209FD6] hover:shadow-[0_6px_20px_rgba(41,168,224,0.38)] hover:-translate-y-0.5 active:translate-y-0 active:scale-[0.99] transition-all duration-200 font-ui"
                  >
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-1.5 rounded-full border border-slate-300 bg-white px-5 py-3 text-xs sm:text-sm font-semibold text-ink hover:border-[#29A8E0]/60 hover:shadow-md hover:-translate-y-0.5 active:translate-y-0 active:scale-[0.99] transition-all duration-200 font-ui shadow-2xs"
                  >
      ...
      <section id="delivery-methodology" className="scroll-mt-24 py-20 lg:py-24 bg-background">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="reveal flex flex-col md:flex-row md:items-end justify-between gap-6 mb-14">
            ...
            <Link
              href="/how-we-operate"
              className="group inline-flex items-center gap-2 rounded-full border border-[#1A6FA8]/25 bg-white px-6 py-3 text-xs sm:text-sm font-bold text-ink transition-all hover:border-[#29A8E0] hover:text-[#1A6FA8] font-ui shadow-2xs shrink-0"
            >
            ...
            {[
              ...
              >
                <div>
                  ...
                  <h3 className="text-lg font-bold text-ink mb-2 font-heading leading-snug">
                    {step.title}
                  </h3>
